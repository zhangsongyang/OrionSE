...
public class MD5
{
    ...
    /**
     * modifyed by xuyun
     * 由于此处涉及到中文的md5问题，统一用UTF8转码后再md5
     * @param s
     * @return
     */
    ...
    {
    	/*md5Init();
    	try{byte[] bytes = s.getBytes("gbk"); 
		md5Update(bytes, s.length());
    	}catch (Exception e) {
        ...
        return digestHexStr;*/
    	return getMD5ofStr(s, "UTF-8");
    }
    
    
    /**
     * 咱们系统旧的md5加密方法，其实是个错误的方法，此处仅仅是为了兼容遗留问题。以后都要用getMD5ofStr(String s,String charSet)指定charset。
     * @param s
     * @return
     */
    public String getMD5ofStr_old(String s)
    {
    	md5Init();
        try{
    ...
    public static void main(String args[])
    {
        ...
        if(Array.getLength(args) == 0)
        {
            ...
            System.out.println("MD5(\"liusong\"):" + md5.getMD5ofStr("liusong"));
        } else
        {
