...
public class UTraceLogBean implements Serializable {
  ...
  public UTraceLogBean() {
    super();
  }

  public UTraceLogBean(String uTraceId, String uSpanId, String step, String bId, String sys,
  ...
  public UTraceLogBean(String uTraceId, String uSpanId, String step, String bId, String sys, String subSys, long ts,
  ...
  public UTraceLogBean(HttpServletRequest request, String spanFix, String step, String retCode,
  ...
  public static void addList(List<UTraceLogBean> list, UTraceLogBean traceLogBean) {
